...
Сценарий: Если дискриминант квадратного уравнения больше 0, то квадратное уравнение имеет два корня кратности 1(при b!=0)
Дано Квадратное уравнение с коэффициентами (1, 3, -4)
Когда вычисляются корни квадратного уравнения
Тогда квадратное уравнение имеет два корня (-4, 1) кратности один 
